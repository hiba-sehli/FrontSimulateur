...
export class DashboardComponent implements OnInit {
  ...
  // FCR Statistics Cards
  fcrStats = [
    {
      title: 'Active FCR Holders',
  ...
  fcrStatusCards = [
    {
      design: 'col-md-6',
      icon: 'fas fa-passport text-c-blue',
      amount: '24',
      color: 'text-c-green',
      percentage: '+12%',
      label: 'Active FCRs',
      ...
      progress_bg: 'bg-c-blue',
      progress: 80,
      progress_bg_2: 'bg-c-green',
      progress2: 60
    },
    {
      design: 'col-md-6',
      icon: 'fas fa-car text-c-purple',
      amount: '15',
      color: 'text-c-red',
      ...
      target: '25',
      duration: '30 days',
      progress_bg: 'bg-c-purple',
      progress: 60,
      progress_bg_2: 'bg-c-red',
      progress2: 50
    }
  ];
